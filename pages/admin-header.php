  ...
  <header>
    <section class="upper-header">
      <section class="signout-container">
        ...
        <form action="../actions/add-book.php" method="get" style="display: inline;">
    ...
    <section class="lower-header">
        <section class="lower-header-content">
          <section>
            <h1>Hello, <?php echo htmlspecialchars($_SESSION['admin_name'] ?? 'Admin'); ?>! Welcome to Lé Bros Library!</h1>
          </section>
